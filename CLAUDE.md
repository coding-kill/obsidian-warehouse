...
| 01_Daily | 每日笔记 | 日记、日复盘、临时待办、随手记、计划总览 |
...
```
01_Daily/
├── logs/                 # 随手记录（原始碎片，按 YYYY-MM-DD.md）
├── daily/               # 正式日报（按年月 YYYY-MM/ 分类）
│   ├── 2025-05/
│   └── 2025-06/
├── Templates/           # 模板（日报模板、随手记模板）
├── 计划总览.md          # 计划总览文件
└── readme.md            # 本说明
```
...
### 每日维护
- 晨间：查看 `计划总览.md`，规划今日待办
- 随时：打开今日随手记 `logs/YYYY-MM-DD.md` 记录碎片
- 随时：想到什么待办或想法，追加到 `计划总览.md`
- 晚间：根据随手记整理正式日报到 `daily/YYYY-MM/YYYY-MM-DD.md`
...
8. **随手记录** → 打开/创建今日随手记 `logs/YYYY-MM-DD.md`
9. **写日报** → 根据随手记整理正式日报，保存到 `daily/YYYY-MM/YYYY-MM-DD.md`
10. **追加计划** → 打开 `计划总览.md`，追加到对应区域（进行中/已完成/未来待办/想法收集）
